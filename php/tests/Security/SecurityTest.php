...
class SecurityTest extends TestCase
{
    public function testNoHardcodedPasswords()
    {
        ...
        foreach ($phpFiles as $file) {
            ...
            $this->assertNotRegExp('/password\s*=\s*[\'"][^\'"]{6,}[\'"]/', $content, 
                "Hardcoded password found in $file");
            
            // Check for hardcoded database credentials
            $this->assertNotRegExp('/MYSQL_PASSWORD\s*=\s*[\'"][^\'"]+[\'"]/', $content,
    ...
    public function testNoSQLInjectionVulnerabilities()
    {
        ...
        foreach ($phpFiles as $file) {
            ...
            $this->assertNotRegExp('/SELECT.*\$_[GET|POST|REQUEST]/', $content,
    ...
    public function testNoXSSVulnerabilities()
    {
        ...
        foreach ($phpFiles as $file) {
            ...
            $this->assertNotRegExp('/echo\s+\$_[GET|POST|REQUEST]/', $content,
